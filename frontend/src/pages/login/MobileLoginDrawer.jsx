    ...
    >
      ...
      <div className="terminal-inner">
        {visible.map((line, i) => {
              ...
              <div key={i} style={{ margin: "14px 0" }}>
                ...
                >
                  <span style={{
                    ...
                    animation: "consolePulse 1s step-end infinite", boxShadow: "0 0 6px #10b981",
                  }} />
                  <span>
                    [ Developer Console ]
                    <span style={{ color: "rgba(16,185,129,0.6)", marginLeft: 8, fontSize: 11 }}>
          ...
          return (
            <p key={i} style={{
              margin: "3px 0", fontSize: 12, color: line.color, lineHeight: 1.7,
              whiteSpace: "pre-wrap", wordBreak: "break-word",
            }}>
              {line.text}
              {i === activeIndex && !allDone && (
                <span style={{
                  display: "inline-block", width: 8, height: 13, background: "#7c83f5",
    ...
    <>
      {phase === "terminal" && (
        <div style={{ opacity: termFading ? 0 : 1, transition: "opacity 0.45s ease" }}>
          <Terminal onDone={handleTermDone} onOpenAbout={() => setShowAbout(true)} />
        </div>
      )}

      {phase === "main" && (
        <div className="app-layout-wrapper">
          {/* ── Dynamic Theme Backgrounds (Kept inline safely for dynamic values) ── */}
          <div style={{
            ...
            <div style={{
              ...
              background: dark ? "linear-gradient(180deg,rgba(8,12,24,0.88) 0%,transparent 100%)" : "linear-gradient(180deg,rgba(244,243,255,0.88) 0%,transparent 100%)",
              pointerEvents: "none", zIndex: 1,
            }} />
            <div style={{
              position: "absolute", bottom: 0, left: 0, right: 0, height: "62%",
              background: dark ? "linear-gradient(0deg,rgba(8,12,24,0.95) 0%,transparent 100%)" : "linear-gradient(0deg,rgba(244,243,255,0.95) 0%,transparent 100%)",
              pointerEvents: "none", zIndex: 1,
            }} />
          </div>
          ...
          <div className="brand-section">
            <h1 style={{
              margin: "0 0 2px", fontSize: "clamp(44px,12vw,62px)", fontWeight: 900,
              letterSpacing: -2, lineHeight: 1, color: dark ? "rgba(255,255,255,0.93)" : "#1e1b4b",
            }}>
              CGPA
            </h1>
            <h1 style={{
              margin: "0 0 14px", fontSize: "clamp(44px,12vw,62px)", fontWeight: 900,
              fontStyle: "italic", letterSpacing: -2, lineHeight: 1.1, paddingBottom: 4, paddingRight: "0.22em",
              background: dark ? "linear-gradient(135deg,#c084fc,#67e8f9)" : "linear-gradient(135deg,#7c3aed,#10b981)",
            ...
            <p style={{
              margin: "0 0 14px", fontSize: 13, color: dark ? "rgba(255,255,255,0.5)" : "#5b5687",
              lineHeight: 1.5,
            }}>
              Track · Predict · Own your academic journey
            </p>

            <div className="feature-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
              {[
                ...
                <div key={f} style={{
                  ...
                  border: `1px solid ${dark ? "rgba(124,131,245,0.14)" : "rgba(109,40,217,0.1)"}`,
                  color: dark ? "rgba(255,255,255,0.6)" : "#5b5687", textAlign: "center",
                }}>
                  {f}
                </div>
              ))}
          ...
          {/* ── Action Box Drawer ── */}
          <div className={`login-drawer ${drawerVisible ? "visible" : ""} ${dark ? "dark-theme" : "light-theme"}`}>
            <div className={`drawer-handle ${dark ? "dark-theme" : "light-theme"}`} />

            <p style={{ margin: "0 0 3px", fontSize: 19, fontWeight: 800, color: dark ? "rgba(255,255,255,0.92)" : "#1e1b4b", textAlign: "center" }}>
              Sign in to get started
            </p>
            <p style={{ margin: "0 0 18px", fontSize: 12, color: dark ? "rgba(255,255,255,0.38)" : "#a09bbf", textAlign: "center" }}>
            ...
            <button
              ...
              style={{
                ...
                justifyContent: "center", gap: 12, transition: "all 0.2s", marginBottom: 14,
            ...
            <button
              ...
              style={{
                ...
                fontFamily: "inherit", display: "flex", alignItems: "center", gap: 12, textAlign: "left", transition: "all 0.2s", animation: "termGlow 3s ease-in-out infinite",
            ...
            >
              <div style={{
                width: 38, height: 38, borderRadius: "50%", background: "linear-gradient(135deg,#6d28d9,#a78bfa)",
                display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 900, color: "#fff", flexShrink: 0, boxShadow: "0 0 12px rgba(109,40,217,0.4)",
              }}>
                KK
              </div>

              <div style={{ flex: 1, minWidth: 0 }}>
                <p style={{ margin: "0 0 1px", fontSize: 13, fontWeight: 700, color: dark ? "rgba(255,255,255,0.88)" : "#1e1b4b" }}>
                  Khushneet Kaur
                </p>
                <p style={{ margin: 0, fontSize: 10, color: dark ? "rgba(255,255,255,0.38)" : "#a09bbf" }}>
            ...
            <p style={{库textAlign: "center", fontSize: 9, color: dark ? "rgba(255,255,255,0.16)" : "#c4bfd8", marginTop: 12, lineHeight: 1.6 }}>
      ...
      {showAbout && <AboutModal onClose={() => setShowAbout(false)} dark={dark} />}
    </>
  );
}