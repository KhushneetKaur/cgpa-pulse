      ...
      {!predSem ? (
        ...
        <>
            ...
            >
              ...
              {breakdown?.targetGrade && (
                ...
                >
                  ...
                  >
                    {breakdown.targetGrade.grade} ({breakdown.targetGrade.points}{" "}
                    pts)
                  </strong>
                  <span
                    style={{
          ...
          >
            ...
            <span>
              <strong style={{ color: c.accent }}>Theory:</strong> Int 40 +
              Ext 60
            </span>
            <span>
              <strong style={{ color: c.ok }}>Lab:</strong> Int 60 + Ext 40
            </span>
          </div>
          ...
          >
            {["Subject", "", "Internal", "External needed per grade"].map(
              (h, i) => (
                <p
                  key={i}
                  style={{
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {subs.map((sub, idx) => {
              ...
              const iV =
                iRaw !== undefined && iRaw !== "" ? Number(iRaw) : null;
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    background:
                      idx % 2 === 0 ? `${c.hover}88` : "transparent",
                    alignItems: "start",
                  }}
                >
                  {/* Subject name */}
