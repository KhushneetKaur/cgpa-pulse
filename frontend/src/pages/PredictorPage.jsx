    ...
    <div style={cardSty()}>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ margin: 0, fontSize: 13, color: c.sub, lineHeight: 1.5 }}>
          Enter your internal marks and desired SGPA — see exactly how many
          external marks you need per subject.
        </p>
      </div>
          ...
          >
            ...
            <div style={{
              ...
              <input
                ...
                placeholder="e.g. 8.0"
                style={inp({ fontSize: 20, fontWeight: 800, textAlign: "center", padding: "8px 10px", background: "transparent", border: `1px solid ${c.accent}55`, color: c.text })}
              />
              {breakdown?.targetGrade && (
                <p style={{ margin: "8px 0 0", fontSize: 11, color: c.sub, lineHeight: 1.4 }}>
                  Min grade needed:{" "}
                  <strong style={{ color: scoreClr(breakdown.targetGrade.points) }}>
                  ...
                  {[
                    ...
                    return (
                      <div key={item.label} style={{ textAlign: "center", flex: 1 }}>
                        <p style={{ margin: 0, fontSize: 9, color: c.muted }}>{item.label}</p>
                        <p style={{ margin: 0, fontSize: 22, fontWeight: 800, letterSpacing: -0.5, color: item.value ? scoreClr(item.value) : c.muted }}>
                          {item.value || "—"}
                        </p>
                        <p style={{ margin: 0, fontSize: 9, color: c.muted }}>{item.sub}</p>
                      </div>
                    );
                  })}
                </div>
